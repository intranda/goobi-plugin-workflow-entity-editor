...
![Auswahl des korrekten Dashboards für den Nutzer](screen1.png)

Nach der erfolgten Auswahl steht das Dashboard für den Nutzer nach dem Login zur Verfügung:

![Dashboard des Artist Dictionary Plugins](screen2.png)

Von hier aus kann die weitere Bearbeitung der Entitäten erfolgen:

![Workflow-Plugin mit der Bearbeitungsmaske für die Entitäten](screen3.png)
