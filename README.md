...
**Documentation (German)**  | https://docs.goobi.io/de/workflow/plugins/workflow/goobi-plugin-workflow-entity-editor
**Documentation (English)** | https://docs.goobi.io/en/workflow/plugins/workflow/goobi-plugin-workflow-entity-editor
